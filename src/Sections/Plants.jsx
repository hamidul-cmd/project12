...
import plantsimg from "../assets/plantsimg.png";

function Plants() {
  return (
    <div className="w-full h-fit px-[55px] py-[62px] flex justify-between">
      <div className="max-w-[292px]">
        <h2 className="text-[44px] font-extrabold leading-[90%] tracking-[-1.5%] mb-14.5">
          Plants for the People
        </h2>
        <p className="text-sm leading-[100%] tracking-[-1.5%]">
          We want our Visitors to be inspire to get their hands dirty
        </p>
      </div>
      <div className="h-[142px] w-[244px] rounded-20 overflow-hidden hover:scale-110 transition-all duration-300 ease-in-out">
        <video
          muted
          autoPlay
          loop
          src="https://static.vecteezy.com/system/resources/previews/042/768/049/mp4/super-slow-motion-bay-leaf-flies-up-and-falls-high-quality-fullhd-footage-video.mp4"
          className="h-full w-full"
        ></video>
      </div>
      <div className="max-w-[686px] text-4xl font-semibold tracking-1.5">
        <h3 className="flex items-center gap-3">
          <div className="whitespace-nowrap">Each plant is cared</div>
          <div className="w-[178px] h-[64px] group relative overflow-hidden rounded-[60px]">
            <img
              src={plantsimg}
              className="object-cover block scale-105"
              alt=""
            />
            <div className="absolute group  top-1/2 left-1/2 -translate-1/2 p-2.5 rounded-full blur_10 group-hover:w-full group-hover:h-full flex justify-center items-center group-hover:scale-105 transition-all duration-300 ease-in">
              <svg
          ...
          <div className="whitespace-nowrap">for by our </div>
        </h3>
        <h3>
          horticultural experts, so they are as happy as healthy as they get.
        </h3>
      </div>
    </div>
  );
